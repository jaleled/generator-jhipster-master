...
const serverFiles = {
    db: [
        ...
        },
       {
            ...
            path: SERVER_MAIN_RES_DIR,
            templates: [{
                file: 'config/bson/changelog/_added_entity.bson',
                renameTo: generator => `config/bson/changelog/${generator.changelogDate}_added_entity_${generator.entityClass}.bson`
            }]
        }
    ],
    server: [
